...
from torchmdnet.models.equiformer_tools.registry import register_model
from torchmdnet.models.equiformer_tools.instance_norm import EquivariantInstanceNorm
from torchmdnet.models.equiformer_tools.graph_norm import EquivariantGraphNorm
from torchmdnet.models.equiformer_tools.layer_norm import EquivariantLayerNormV2
from torchmdnet.models.equiformer_tools.fast_layer_norm import EquivariantLayerNormFast
from torchmdnet.models.equiformer_tools.radial_func import RadialProfile
from torchmdnet.models.equiformer_tools.tensor_product_rescale import (TensorProductRescale, LinearRS,
    FullyConnectedTensorProductRescale, irreps2gate, sort_irreps_even_first)
from torchmdnet.models.equiformer_tools.fast_activation import Activation, Gate
from torchmdnet.models.equiformer_tools.drop import EquivariantDropout, EquivariantScalarsDropout, GraphDropPath
from torchmdnet.models.equiformer_tools.gaussian_rbf import GaussianRadialBasisLayer
...
# QM9
# _MAX_ATOM_TYPE = 5
_MAX_ATOM_TYPE = 118    ## period_atomic_number have 118 keys
...
class GraphAttentionTransformer(torch.nn.Module):
    def __init__(self,
        ...
        self.head = torch.nn.Sequential(
            ...
            LinearRS(self.irreps_feature, o3.Irreps(output_dimension), rescale=_RESCALE))

        self.noiseHead = torch.nn.Sequential(
            LinearRS(self.irreps_feature, self.irreps_feature, rescale=_RESCALE),
            Activation(self.irreps_feature, acts=[torch.nn.SiLU()]),
    ...
    def forward(self, node_atom, pos, batch, return_e=False, type_idx=None, **kwargs) -> torch.Tensor:
        ...
        ## seems no use now, for node_atom is the z, and can be directly used in self.atom_embed
        ...
        noisePred = self.noiseHead(node_features)
